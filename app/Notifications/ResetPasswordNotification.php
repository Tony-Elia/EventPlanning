...
class ResetPasswordNotification extends Notification
{
    ...
    {
        // For API: You can customize this URL to point to your frontend reset password page
        // Example: $url = config('app.frontend_url') . '/reset-password?token=' . $this->token . '&email=' . $notifiable->email;
